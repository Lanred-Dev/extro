...
from extro.shared import Vector2


class StaticDrawableInstance(DrawableInstance):
    ...
    def _render_texture(self):
        raise NotImplementedError("`_render_texture` must be implemented by subclass")
