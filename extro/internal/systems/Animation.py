...
def update():
    ...
    for sprite_id in sprites:
        ...
        if (
            sprite._is_active
            and current_time - sprite._last_frame_at >= sprite._frame_duration
        ):
            sprite._current_frame = (sprite._current_frame + 1) % sprite._frame_count
            sprite._texture_source.x = sprite._current_frame * sprite._source_size.x  # type: ignore
