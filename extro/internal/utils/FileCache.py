from typing import Any, TYPE_CHECKING, Generic, TypeVar, Callable
...
class FileCache(Generic[CacheFileType, FileType]):
    ...
    def get(self, path: str) -> FileType:
        # If there is no clone loader then FileType is the same as CacheFileType
    ...
    def unload_if_needed(self, path: str):
