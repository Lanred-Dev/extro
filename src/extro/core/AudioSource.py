...
import extro.internal.services.AudioService as AudioService
...
class AudioSource:
    ...
    def __init__(
        ...
        AudioSystem.register(self)

    def destroy(self):
        self.on_finish.destroy()
        self._unload_audio()
        AudioSystem.unregister(self._id)
    ...
    def _load_audio(self):
        ...
        if self._is_stream:
            ...
            self._audio = AudioService.sound_cache.get(self._audio_file)
    ...
    def _unload_audio(self):
        ...
        if self._is_stream:
            ...
            AudioService.sound_cache.unload_if_needed(self._audio_file)
